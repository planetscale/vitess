...
func registerCommands(root *cobra.Command) {
	...
	create.Flags().Int64Var(&createOptions.TenantId, "tenant-id", 0, "(EXPERIMENTAL) Use this for importing from a multi-tenant system where each tenant has its own database.")
