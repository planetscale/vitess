...
type Regexp struct {
	...
	options syntax.RegexOptions // options
...
func Compile(expr string, opt syntax.RegexOptions) (*Regexp, error) {
	// parse it
	tree, err := syntax.Parse(expr, opt)
	if err != nil {
		return nil, err
	}
...
// expressions.
func MustCompile(str string, opt syntax.RegexOptions) *Regexp {
...
func (re *Regexp) RightToLeft() bool {
	return re.options&syntax.RightToLeft != 0
}

func (re *Regexp) Debug() bool {
	return re.options&syntax.Debug != 0
}
