...
package utf32 // import "vitess.io/vitess/go/mysql/collations/vindex/encoding/unicode/utf32"

import (
	"errors"
	"unicode/utf8"

	"vitess.io/vitess/go/mysql/collations/vindex/encoding"
	"vitess.io/vitess/go/mysql/collations/vindex/encoding/internal/identifier"
...
const (
	...
	// Consistent with BOMPolicy definition in vitess.io/vitess/go/mysql/collations/vindex/encoding/unicode
)
