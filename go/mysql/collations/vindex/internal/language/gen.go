...
import (
	...
	"vitess.io/vitess/go/mysql/collations/vindex/internal/gen"
	"vitess.io/vitess/go/mysql/collations/vindex/internal/tag"
...
func main() {
	...
	fmt.Fprintln(w, `import "vitess.io/vitess/go/mysql/collations/vindex/internal/tag"`)
