...
[![Go Reference](https://pkg.go.dev/badge/vitess.io/vitess/go/mysql/collations/vindex.svg)](https://pkg.go.dev/vitess.io/vitess/go/mysql/collations/vindex)
...
The easiest way to install is to run `go get -u vitess.io/vitess/go/mysql/collations/vindex`. You can
also manually git clone the repository to `$GOPATH/src/vitess.io/vitess/go/mysql/collations/vindex`.
...
vitess.io/vitess/go/mysql/collations/vindex/unicode/cldr.
