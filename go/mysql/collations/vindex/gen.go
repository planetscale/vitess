...
func copyExported(p string) {
	copyPackage(
		...
		"vitess.io/vitess/go/mysql/collations/vindex/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in vitess.io/vitess/go/mysql/collations/vindex. DO NOT EDIT.\n\n"
