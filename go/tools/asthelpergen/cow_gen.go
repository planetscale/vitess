...
func (c *cowGen) interfaceMethod(t types.Type, iface *types.Interface, spi generatorSPI) error {
	...
	funcDecl := jen.Func().Params(jen.Id("c").Id("*cowCursor")).Id(funcName).Call(jen.Id("in").Id(typeString)).Params(jen.Id(typeString), jen.Id("bool")).Block(stmts...)
