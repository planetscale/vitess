...
func TestInstanceKeyEquals(t *testing.T) {
	...
	require.EqualValues(t, i1.Key().String(), i2.Key().String())

	i2.Port = 3307
	require.NotEqualValues(t, i1.Key().String(), i2.Key().String())
}
...
func TestNewResolveInstanceKey(t *testing.T) {
	{
		...
		require.EqualValues(t, i.Hostname, "127.0.0.1")
		require.EqualValues(t, i.Port, 3308)
	}
	{
...
func TestParseResolveInstanceKey(t *testing.T) {
	{
		...
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "myhost")
		require.EqualValues(t, key.Port, 1234)
	}
	{
		key, err := ParseResolveInstanceKey("myhost")
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "myhost")
		require.EqualValues(t, key.Port, 3306)
	}
	{
		key, err := ParseResolveInstanceKey("10.0.0.3:3307")
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "10.0.0.3")
		require.EqualValues(t, key.Port, 3307)
	}
	{
	...
	}
	{
		...
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "2001:db8:1f70::999:de8:7648:6e8")
		require.EqualValues(t, key.Port, 3308)
	}
	{
		key, err := ParseResolveInstanceKey("::1")
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "::1")
		require.EqualValues(t, key.Port, 3306)
	}
	{
		key, err := ParseResolveInstanceKey("0:0:0:0:0:0:0:0")
		require.NoError(t, err)
		require.EqualValues(t, key.Hostname, "0:0:0:0:0:0:0:0")
		require.EqualValues(t, key.Port, 3306)
	}
	{
...
func TestNewResolveInstanceKeyStrings(t *testing.T) {
	{
		...
		require.NoError(t, err)
		require.EqualValues(t, i.Hostname, "127.0.0.1")
		require.EqualValues(t, i.Port, 3306)
	}
	{
