...
func TestMkInsertOdkuSingle(t *testing.T) {
	...
	s1 := `INSERT ignore INTO database_instance
                (alias, hostname, port, last_checked, last_attempted_check, last_check_partial_success, uptime, server_id, server_uuid,
        ...
        `
	a1 := `zone1-i710, i710, 3306, 0, 710, , 5.6.7, 5.6, MySQL, false, false, STATEMENT,
...
func TestMkInsertOdkuThree(t *testing.T) {
	...
	s3 := `INSERT  INTO database_instance
        ...
        `
	a3 := `
		zone1-i710, i710, 3306, 0, 710, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 10, , 0, , , {0 false}, {0 false}, 0, 0, [], , , , , , 0, false, false, false, false, false, false, false, 0, 0, false, false, 0, false, 0,
		zone1-i720, i720, 3306, 0, 720, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 20, , 0, , , {0 false}, {0 false}, 0, 0, [], , , , , , 0, false, false, false, false, false, false, false, 0, 0, false, false, 0, false, 0,
		zone1-i730, i730, 3306, 0, 730, , 5.6.7, 5.6, MySQL, false, false, STATEMENT, FULL, false, false, , 0, , 0, false, false, 0, 0, false, false, false, , , , , , , false, false, , 0, mysql.000007, 30, , 0, , , {0 false}, {0 false}, 0, 0, [], , , , , , 0, false, false, false, false, false, false, false, 0, 0, false, false, 0, false, 0,
		`
...
func TestReadReplicaInstances(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			// This tabletPort corresponds to zone1-0000000100. That is the primary for the data inserted.
			...
			// This tabletPort corresponds to zone1-0000000101. That is a replica tablet, with no replicas of its own.
			// Check initialSQL for more details.
			tabletPort:  10912,
			replicasLen: 0,
		},
...
func TestReadProblemInstances(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			instances, err := ReadProblemInstances("")
			require.NoError(t, err)
...
func TestReadInstancesByCondition(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			instancesRequired: []string{"zone1-0000000101", "zone1-0000000112", "zone2-0000000200"},
		}, {
...
func TestSnapshotTopologies(t *testing.T) {
	...
	var tabletAliases []string
	err = db.QueryOrchestrator(query, nil, func(rowMap sqlutils.RowMap) error {
