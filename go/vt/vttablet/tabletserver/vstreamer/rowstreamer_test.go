...
func TestStreamRowsScan(t *testing.T) {
	...
	wantQuery := "select /*+ MAX_EXECUTION_TIME(3600000) */ id, val from t1 order by id"
	...
	wantQuery = "select /*+ MAX_EXECUTION_TIME(3600000) */ id, val from t1 where (id > 1) order by id"
	...
	wantQuery = "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, id2, val from t2 order by id1, id2"
	...
	wantQuery = "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, id2, val from t2 where (id1 = 1 and id2 > 2) or (id1 > 1) order by id1, id2"
	...
	wantQuery = "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, id2, id3, val from t4 order by id1, id2, id3"
	...
	wantQuery = "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, id2, id3, val from t4 where (id1 = 1 and id2 = 2 and id3 > 3) or (id1 = 1 and id2 > 2) or (id1 > 1) order by id1, id2, id3"
...
func TestStreamRowsKeyRange(t *testing.T) {
	...
	wantQuery := "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, val from t1 order by id1"
...
func TestStreamRowsFilterInt(t *testing.T) {
	...
	wantQuery := "select /*+ MAX_EXECUTION_TIME(3600000) */ id1, id2, val from t1 order by id1"
