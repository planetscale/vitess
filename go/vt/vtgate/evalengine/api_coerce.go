...
func CoerceTypes(v1, v2 Type) (out Type, err error) {
	...
	if sqltypes.IsNull(v1.Type()) || sqltypes.IsNull(v2.Type()) {
		return Type{typ: sqltypes.Null, collation: collations.CollationBinaryID, nullable: true}, nil
	}
	fail := func() error {
	...
	case sqltypes.IsTextOrBinary(v1.Type()) && sqltypes.IsTextOrBinary(v2.Type()):
		...
		mergedCollation, _, _, ferr := mergeCollations(typedCoercionCollation(v1.Type(), v1.collation), typedCoercionCollation(v2.Type(), v2.collation), v1.typ, v2.typ)
		if err != nil {
			return Type{}, ferr
		}
