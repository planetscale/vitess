...
func TestExpandStar(t *testing.T) {
	...
	tcases := []struct {
		...
		expSQL: "select t1.b, t1.a, t1.c, t5.a from t1 join t5 on t1.b = t5.b having b = 12",
	}, {
		...
		expSQL: "select results.c1, results.c2, results.foo from (select t2.c1, t2.c2, 12 as foo from t3, t2) as results",
	}}
