...
func (code AggregateOpcode) ResolveType(t evalengine.Type) evalengine.Type {
	sqltype := code.SQLType(t.Type())
	collation := collations.CollationForType(sqltype, collations.ID(collations.Local().DefaultConnectionCharset()))
