...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x4c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x53, 0x68, 0x61, 0x72,
	...
	0x65, 0x52, 0x07, 0x76, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xae, 0x01, 0x0a, 0x13, 0x47,
	...
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x4c, 0x6f, 0x67, 0x73, 0x22, 0x49, 0x0a, 0x14, 0x47,
	...
	0x65, 0x73, 0x22, 0xbb, 0x06, 0x0a, 0x17, 0x4d, 0x6f, 0x76, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65,
...
var file_vtctldata_proto_goTypes = []interface{}{
	...
	(*topodata.Keyspace_ServedFrom)(nil),                        // 290: topodata.Keyspace.ServedFrom
	...
	(*topodata.SrvKeyspace)(nil),                                // 307: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 308: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 309: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	...
	290, // 43: vtctldata.CreateKeyspaceRequest.served_froms:type_name -> topodata.Keyspace.ServedFrom
	291, // 44: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	279, // 45: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	280, // 50: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	280, // 51: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	280, // 52: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	281, // 53: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	280, // 54: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	276, // 55: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	280, // 56: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 57: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	280, // 58: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	292, // 59: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	280, // 60: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	...
	283, // 66: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	253, // 67: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	280, // 68: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	...
	280, // 72: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 73: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	284, // 74: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	280, // 75: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	...
	281, // 78: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	285, // 82: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	254, // 83: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	256, // 84: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	...
	257, // 87: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	280, // 88: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	289, // 89: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	280, // 90: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	288, // 91: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	289, // 92: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	105, // 93: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	280, // 94: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	287, // 95: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	11,  // 96: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	280, // 97: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	281, // 98: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	276, // 99: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	258, // 100: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	287, // 101: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	288, // 102: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	277, // 103: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 104: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	288, // 105: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	277, // 106: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	288, // 107: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	277, // 108: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	259, // 109: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	280, // 110: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 111: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	280, // 112: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	281, // 113: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	281, // 114: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	280, // 115: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	276, // 116: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	280, // 117: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 118: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	276, // 119: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	276, // 120: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	280, // 121: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	280, // 122: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	288, // 123: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	277, // 124: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	280, // 125: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	279, // 126: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	279, // 127: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	280, // 128: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	276, // 129: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	260, // 130: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	280, // 131: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	278, // 132: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	288, // 133: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	278, // 134: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	278, // 135: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	282, // 136: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	288, // 137: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	282, // 138: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	280, // 139: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 140: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	301, // 141: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	261, // 142: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	262, // 143: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	280, // 144: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 145: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	281, // 146: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	302, // 147: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	282, // 148: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	282, // 149: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	280, // 150: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 151: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	280, // 152: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	280, // 153: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	280, // 154: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	283, // 155: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	283, // 156: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	...
	263, // 159: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	264, // 160: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	265, // 161: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	266, // 162: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	267, // 163: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	288, // 164: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	277, // 165: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	281, // 166: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	281, // 167: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	268, // 168: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	269, // 169: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	273, // 170: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	274, // 171: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	288, // 172: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	281, // 173: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	281, // 174: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	304, // 175: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	275, // 176: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	240, // 177: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	241, // 178: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	305, // 179: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	280, // 180: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	306, // 181: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	279, // 182: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	279, // 183: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	242, // 184: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	243, // 185: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	244, // 186: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	279, // 187: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	279, // 188: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	279, // 189: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	247, // 190: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 191: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	303, // 192: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	255, // 193: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	307, // 194: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	300, // 195: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	280, // 196: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	308, // 197: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	289, // 198: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	209, // 199: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	213, // 200: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 201: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 202: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	213, // 203: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	309, // 204: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	280, // 205: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	280, // 206: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	271, // 207: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	270, // 208: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	272, // 209: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	280, // 210: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
