...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x9b, 0x01, 0x0a, 0x17, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x54, 0x61, 0x62, 0x6c,
...
var file_vtctldata_proto_depIdxs = []int32{
	...
	208, // 78: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	211, // 79: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	202, // 80: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	211, // 81: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 82: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	202, // 83: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	202, // 84: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	211, // 85: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	211, // 86: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	211, // 87: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	216, // 88: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	216, // 89: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	211, // 90: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	202, // 91: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	211, // 92: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	203, // 93: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	212, // 94: vtctldata.SetKeyspaceServedFromRequest.tablet_type:type_name -> topodata.TabletType
	203, // 95: vtctldata.SetKeyspaceServedFromResponse.keyspace:type_name -> topodata.Keyspace
	203, // 96: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	204, // 97: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	212, // 98: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	204, // 99: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	211, // 100: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 101: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	226, // 102: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	194, // 103: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	195, // 104: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	211, // 105: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 106: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	208, // 107: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	227, // 108: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	204, // 109: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	204, // 110: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	211, // 111: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 112: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	211, // 113: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	211, // 114: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	211, // 115: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	205, // 116: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	205, // 117: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	228, // 118: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	228, // 119: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	196, // 120: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	197, // 121: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	198, // 122: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	199, // 123: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	200, // 124: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	229, // 125: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVRWorkflowRequest
	201, // 126: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	184, // 127: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	185, // 128: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	230, // 129: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	211, // 130: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	231, // 131: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	216, // 132: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	216, // 133: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	186, // 134: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	187, // 135: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	216, // 136: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	216, // 137: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	6,   // 138: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	228, // 139: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	191, // 140: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	232, // 141: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	225, // 142: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	233, // 143: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	213, // 144: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	169, // 145: vtctldata.ValidateResponse.ResultsByKeyspaceEntry.value:type_name -> vtctldata.ValidateKeyspaceResponse
	173, // 146: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	173, // 147: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	173, // 148: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
	173, // 149: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry.value:type_name -> vtctldata.ValidateShardResponse
