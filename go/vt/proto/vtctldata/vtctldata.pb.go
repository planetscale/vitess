...
var file_vtctldata_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x2f, 0x0a, 0x11, 0x47, 0x65, 0x74,
	...
	0x6e, 0x73, 0x65, 0x22, 0x94, 0x03, 0x0a, 0x1b, 0x50, 0x6c, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x52,
	...
	0x6c, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xba, 0x01, 0x0a, 0x1c, 0x50,
...
var file_vtctldata_proto_msgTypes = make([]protoimpl.MessageInfo, 289)
var file_vtctldata_proto_goTypes = []any{
	...
	nil,                                          // 253: vtctldata.WorkflowOptions.ConfigEntry
	nil,                                          // 254: vtctldata.Workflow.ShardStreamsEntry
	(*Workflow_ReplicationLocation)(nil),         // 255: vtctldata.Workflow.ReplicationLocation
	(*Workflow_ShardStream)(nil),                 // 256: vtctldata.Workflow.ShardStream
	(*Workflow_Stream)(nil),                      // 257: vtctldata.Workflow.Stream
	(*Workflow_Stream_CopyState)(nil),            // 258: vtctldata.Workflow.Stream.CopyState
	(*Workflow_Stream_Log)(nil),                  // 259: vtctldata.Workflow.Stream.Log
	(*Workflow_Stream_ThrottlerStatus)(nil),      // 260: vtctldata.Workflow.Stream.ThrottlerStatus
	nil,                                          // 261: vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	nil,                                          // 262: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry
	(*ApplyVSchemaResponse_ParamList)(nil),       // 263: vtctldata.ApplyVSchemaResponse.ParamList
	nil,                                          // 264: vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 265: vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 266: vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 267: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	nil,                                          // 268: vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	nil,                                          // 269: vtctldata.GetCellsAliasesResponse.AliasesEntry
	nil,                                          // 270: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	nil,                                          // 271: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	(*GetSrvKeyspaceNamesResponse_NameList)(nil), // 272: vtctldata.GetSrvKeyspaceNamesResponse.NameList
	nil, // 273: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	nil, // 274: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	nil, // 275: vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	(*MoveTablesCreateResponse_TabletInfo)(nil), // 276: vtctldata.MoveTablesCreateResponse.TabletInfo
	nil, // 277: vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	nil, // 278: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	nil, // 279: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	nil, // 280: vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	nil, // 281: vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	nil, // 282: vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	nil, // 283: vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	nil, // 284: vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	nil, // 285: vtctldata.VDiffShowResponse.TabletResponsesEntry
	(*WorkflowDeleteResponse_TabletInfo)(nil),       // 286: vtctldata.WorkflowDeleteResponse.TabletInfo
	(*WorkflowStatusResponse_TableCopyState)(nil),   // 287: vtctldata.WorkflowStatusResponse.TableCopyState
	(*WorkflowStatusResponse_ShardStreamState)(nil), // 288: vtctldata.WorkflowStatusResponse.ShardStreamState
	(*WorkflowStatusResponse_ShardStreams)(nil),     // 289: vtctldata.WorkflowStatusResponse.ShardStreams
	nil, // 290: vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	nil, // 291: vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	(*WorkflowUpdateResponse_TabletInfo)(nil),                   // 292: vtctldata.WorkflowUpdateResponse.TabletInfo
	(*logutil.Event)(nil),                                       // 293: logutil.Event
	(tabletmanagerdata.TabletSelectionPreference)(0),            // 294: tabletmanagerdata.TabletSelectionPreference
	(*topodata.Keyspace)(nil),                                   // 295: topodata.Keyspace
	(*vttime.Time)(nil),                                         // 296: vttime.Time
	(*topodata.TabletAlias)(nil),                                // 297: topodata.TabletAlias
	(*vttime.Duration)(nil),                                     // 298: vttime.Duration
	(*topodata.Shard)(nil),                                      // 299: topodata.Shard
	(*topodata.CellInfo)(nil),                                   // 300: topodata.CellInfo
	(*vschema.KeyspaceRoutingRules)(nil),                        // 301: vschema.KeyspaceRoutingRules
	(*vschema.RoutingRules)(nil),                                // 302: vschema.RoutingRules
	(*vschema.ShardRoutingRules)(nil),                           // 303: vschema.ShardRoutingRules
	(*vtrpc.CallerID)(nil),                                      // 304: vtrpc.CallerID
	(*vschema.Keyspace)(nil),                                    // 305: vschema.Keyspace
	(topodata.TabletType)(0),                                    // 306: topodata.TabletType
	(*topodata.Tablet)(nil),                                     // 307: topodata.Tablet
	(*tabletmanagerdata.CheckThrottlerResponse)(nil),            // 308: tabletmanagerdata.CheckThrottlerResponse
	(topodata.KeyspaceType)(0),                                  // 309: topodata.KeyspaceType
	(*query.QueryResult)(nil),                                   // 310: query.QueryResult
	(*tabletmanagerdata.ExecuteHookRequest)(nil),                // 311: tabletmanagerdata.ExecuteHookRequest
	(*tabletmanagerdata.ExecuteHookResponse)(nil),               // 312: tabletmanagerdata.ExecuteHookResponse
	(*mysqlctl.BackupInfo)(nil),                                 // 313: mysqlctl.BackupInfo
	(*replicationdata.FullStatus)(nil),                          // 314: replicationdata.FullStatus
	(*tabletmanagerdata.Permissions)(nil),                       // 315: tabletmanagerdata.Permissions
	(*tabletmanagerdata.SchemaDefinition)(nil),                  // 316: tabletmanagerdata.SchemaDefinition
	(*topodata.ThrottledAppRule)(nil),                           // 317: topodata.ThrottledAppRule
	(*vschema.SrvVSchema)(nil),                                  // 318: vschema.SrvVSchema
	(*tabletmanagerdata.GetThrottlerStatusResponse)(nil),        // 319: tabletmanagerdata.GetThrottlerStatusResponse
	(*topodata.ShardReplicationError)(nil),                      // 320: topodata.ShardReplicationError
	(*topodata.KeyRange)(nil),                                   // 321: topodata.KeyRange
	(*topodata.CellsAlias)(nil),                                 // 322: topodata.CellsAlias
	(*tabletmanagerdata.UpdateVReplicationWorkflowRequest)(nil), // 323: tabletmanagerdata.UpdateVReplicationWorkflowRequest
	(*vschema.MirrorRules)(nil),                                 // 324: vschema.MirrorRules
	(*topodata.Shard_TabletControl)(nil),                        // 325: topodata.Shard.TabletControl
	(*binlogdata.BinlogSource)(nil),                             // 326: binlogdata.BinlogSource
	(*topodata.ShardReplication)(nil),                           // 327: topodata.ShardReplication
	(*topodata.SrvKeyspace)(nil),                                // 328: topodata.SrvKeyspace
	(*replicationdata.Status)(nil),                              // 329: replicationdata.Status
	(*tabletmanagerdata.VDiffResponse)(nil),                     // 330: tabletmanagerdata.VDiffResponse
}
var file_vtctldata_proto_depIdxs = []int32{
	293, // 0: vtctldata.ExecuteVtctlCommandResponse.event:type_name -> logutil.Event
	...
	294, // 3: vtctldata.MaterializeSettings.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 4: vtctldata.MaterializeSettings.workflow_options:type_name -> vtctldata.WorkflowOptions
	295, // 5: vtctldata.Keyspace.keyspace:type_name -> topodata.Keyspace
	2,   // 6: vtctldata.SchemaMigration.strategy:type_name -> vtctldata.SchemaMigration.Strategy
	296, // 7: vtctldata.SchemaMigration.added_at:type_name -> vttime.Time
	296, // 8: vtctldata.SchemaMigration.requested_at:type_name -> vttime.Time
	296, // 9: vtctldata.SchemaMigration.ready_at:type_name -> vttime.Time
	296, // 10: vtctldata.SchemaMigration.started_at:type_name -> vttime.Time
	296, // 11: vtctldata.SchemaMigration.liveness_timestamp:type_name -> vttime.Time
	296, // 12: vtctldata.SchemaMigration.completed_at:type_name -> vttime.Time
	296, // 13: vtctldata.SchemaMigration.cleaned_up_at:type_name -> vttime.Time
	3,   // 14: vtctldata.SchemaMigration.status:type_name -> vtctldata.SchemaMigration.Status
	297, // 15: vtctldata.SchemaMigration.tablet:type_name -> topodata.TabletAlias
	298, // 16: vtctldata.SchemaMigration.artifact_retention:type_name -> vttime.Duration
	296, // 17: vtctldata.SchemaMigration.last_throttled_at:type_name -> vttime.Time
	296, // 18: vtctldata.SchemaMigration.cancelled_at:type_name -> vttime.Time
	296, // 19: vtctldata.SchemaMigration.reviewed_at:type_name -> vttime.Time
	296, // 20: vtctldata.SchemaMigration.ready_to_complete_at:type_name -> vttime.Time
	299, // 21: vtctldata.Shard.shard:type_name -> topodata.Shard
	253, // 22: vtctldata.WorkflowOptions.config:type_name -> vtctldata.WorkflowOptions.ConfigEntry
	255, // 23: vtctldata.Workflow.source:type_name -> vtctldata.Workflow.ReplicationLocation
	255, // 24: vtctldata.Workflow.target:type_name -> vtctldata.Workflow.ReplicationLocation
	254, // 25: vtctldata.Workflow.shard_streams:type_name -> vtctldata.Workflow.ShardStreamsEntry
	11,  // 26: vtctldata.Workflow.options:type_name -> vtctldata.WorkflowOptions
	300, // 27: vtctldata.AddCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	301, // 28: vtctldata.ApplyKeyspaceRoutingRulesRequest.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	301, // 29: vtctldata.ApplyKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	302, // 30: vtctldata.ApplyRoutingRulesRequest.routing_rules:type_name -> vschema.RoutingRules
	303, // 31: vtctldata.ApplyShardRoutingRulesRequest.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	298, // 32: vtctldata.ApplySchemaRequest.wait_replicas_timeout:type_name -> vttime.Duration
	304, // 33: vtctldata.ApplySchemaRequest.caller_id:type_name -> vtrpc.CallerID
	261, // 34: vtctldata.ApplySchemaResponse.rows_affected_by_shard:type_name -> vtctldata.ApplySchemaResponse.RowsAffectedByShardEntry
	305, // 35: vtctldata.ApplyVSchemaRequest.v_schema:type_name -> vschema.Keyspace
	305, // 36: vtctldata.ApplyVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	262, // 37: vtctldata.ApplyVSchemaResponse.unknown_vindex_params:type_name -> vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry
	297, // 38: vtctldata.BackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 39: vtctldata.BackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	293, // 40: vtctldata.BackupResponse.event:type_name -> logutil.Event
	264, // 41: vtctldata.CancelSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CancelSchemaMigrationResponse.RowsAffectedByShardEntry
	297, // 42: vtctldata.ChangeTabletTypeRequest.tablet_alias:type_name -> topodata.TabletAlias
	306, // 43: vtctldata.ChangeTabletTypeRequest.db_type:type_name -> topodata.TabletType
	307, // 44: vtctldata.ChangeTabletTypeResponse.before_tablet:type_name -> topodata.Tablet
	307, // 45: vtctldata.ChangeTabletTypeResponse.after_tablet:type_name -> topodata.Tablet
	297, // 46: vtctldata.CheckThrottlerRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 47: vtctldata.CheckThrottlerResponse.tablet_alias:type_name -> topodata.TabletAlias
	308, // 48: vtctldata.CheckThrottlerResponse.Check:type_name -> tabletmanagerdata.CheckThrottlerResponse
	265, // 49: vtctldata.CleanupSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CleanupSchemaMigrationResponse.RowsAffectedByShardEntry
	266, // 50: vtctldata.CompleteSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.CompleteSchemaMigrationResponse.RowsAffectedByShardEntry
	309, // 51: vtctldata.CreateKeyspaceRequest.type:type_name -> topodata.KeyspaceType
	296, // 52: vtctldata.CreateKeyspaceRequest.snapshot_time:type_name -> vttime.Time
	...
	297, // 57: vtctldata.DeleteTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	297, // 58: vtctldata.EmergencyReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	297, // 59: vtctldata.EmergencyReparentShardRequest.ignore_replicas:type_name -> topodata.TabletAlias
	298, // 60: vtctldata.EmergencyReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	297, // 61: vtctldata.EmergencyReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	293, // 62: vtctldata.EmergencyReparentShardResponse.events:type_name -> logutil.Event
	297, // 63: vtctldata.ExecuteFetchAsAppRequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 64: vtctldata.ExecuteFetchAsAppResponse.result:type_name -> query.QueryResult
	297, // 65: vtctldata.ExecuteFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 66: vtctldata.ExecuteFetchAsDBAResponse.result:type_name -> query.QueryResult
	297, // 67: vtctldata.ExecuteHookRequest.tablet_alias:type_name -> topodata.TabletAlias
	311, // 68: vtctldata.ExecuteHookRequest.tablet_hook_request:type_name -> tabletmanagerdata.ExecuteHookRequest
	312, // 69: vtctldata.ExecuteHookResponse.hook_result:type_name -> tabletmanagerdata.ExecuteHookResponse
	297, // 70: vtctldata.ExecuteMultiFetchAsDBARequest.tablet_alias:type_name -> topodata.TabletAlias
	310, // 71: vtctldata.ExecuteMultiFetchAsDBAResponse.results:type_name -> query.QueryResult
	267, // 72: vtctldata.FindAllShardsInKeyspaceResponse.shards:type_name -> vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry
	268, // 73: vtctldata.ForceCutOverSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.ForceCutOverSchemaMigrationResponse.RowsAffectedByShardEntry
	313, // 74: vtctldata.GetBackupsResponse.backups:type_name -> mysqlctl.BackupInfo
	300, // 75: vtctldata.GetCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	269, // 76: vtctldata.GetCellsAliasesResponse.aliases:type_name -> vtctldata.GetCellsAliasesResponse.AliasesEntry
	297, // 77: vtctldata.GetFullStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	314, // 78: vtctldata.GetFullStatusResponse.status:type_name -> replicationdata.FullStatus
	...
	297, // 81: vtctldata.GetPermissionsRequest.tablet_alias:type_name -> topodata.TabletAlias
	315, // 82: vtctldata.GetPermissionsResponse.permissions:type_name -> tabletmanagerdata.Permissions
	301, // 83: vtctldata.GetKeyspaceRoutingRulesResponse.keyspace_routing_rules:type_name -> vschema.KeyspaceRoutingRules
	302, // 84: vtctldata.GetRoutingRulesResponse.routing_rules:type_name -> vschema.RoutingRules
	297, // 85: vtctldata.GetSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	316, // 86: vtctldata.GetSchemaResponse.schema:type_name -> tabletmanagerdata.SchemaDefinition
	3,   // 87: vtctldata.GetSchemaMigrationsRequest.status:type_name -> vtctldata.SchemaMigration.Status
	298, // 88: vtctldata.GetSchemaMigrationsRequest.recent:type_name -> vttime.Duration
	...
	270, // 91: vtctldata.GetShardReplicationResponse.shard_replication_by_cell:type_name -> vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry
	10,  // 92: vtctldata.GetShardResponse.shard:type_name -> vtctldata.Shard
	303, // 93: vtctldata.GetShardRoutingRulesResponse.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	271, // 94: vtctldata.GetSrvKeyspaceNamesResponse.names:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry
	273, // 95: vtctldata.GetSrvKeyspacesResponse.srv_keyspaces:type_name -> vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry
	317, // 96: vtctldata.UpdateThrottlerConfigRequest.throttled_app:type_name -> topodata.ThrottledAppRule
	318, // 97: vtctldata.GetSrvVSchemaResponse.srv_v_schema:type_name -> vschema.SrvVSchema
	274, // 98: vtctldata.GetSrvVSchemasResponse.srv_v_schemas:type_name -> vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry
	297, // 99: vtctldata.GetTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	307, // 100: vtctldata.GetTabletResponse.tablet:type_name -> topodata.Tablet
	297, // 101: vtctldata.GetTabletsRequest.tablet_aliases:type_name -> topodata.TabletAlias
	306, // 102: vtctldata.GetTabletsRequest.tablet_type:type_name -> topodata.TabletType
	307, // 103: vtctldata.GetTabletsResponse.tablets:type_name -> topodata.Tablet
	297, // 104: vtctldata.GetThrottlerStatusRequest.tablet_alias:type_name -> topodata.TabletAlias
	319, // 105: vtctldata.GetThrottlerStatusResponse.status:type_name -> tabletmanagerdata.GetThrottlerStatusResponse
	118, // 106: vtctldata.GetTopologyPathResponse.cell:type_name -> vtctldata.TopologyCell
	297, // 107: vtctldata.GetVersionRequest.tablet_alias:type_name -> topodata.TabletAlias
	305, // 108: vtctldata.GetVSchemaResponse.v_schema:type_name -> vschema.Keyspace
	12,  // 109: vtctldata.GetWorkflowsResponse.workflows:type_name -> vtctldata.Workflow
	297, // 110: vtctldata.InitShardPrimaryRequest.primary_elect_tablet_alias:type_name -> topodata.TabletAlias
	298, // 111: vtctldata.InitShardPrimaryRequest.wait_replicas_timeout:type_name -> vttime.Duration
	293, // 112: vtctldata.InitShardPrimaryResponse.events:type_name -> logutil.Event
	275, // 113: vtctldata.LaunchSchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.LaunchSchemaMigrationResponse.RowsAffectedByShardEntry
	305, // 114: vtctldata.LookupVindexCreateRequest.vindex:type_name -> vschema.Keyspace
	306, // 115: vtctldata.LookupVindexCreateRequest.tablet_types:type_name -> topodata.TabletType
	294, // 116: vtctldata.LookupVindexCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	7,   // 117: vtctldata.MaterializeCreateRequest.settings:type_name -> vtctldata.MaterializeSettings
	306, // 118: vtctldata.MigrateCreateRequest.tablet_types:type_name -> topodata.TabletType
	294, // 119: vtctldata.MigrateCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	306, // 120: vtctldata.MoveTablesCreateRequest.tablet_types:type_name -> topodata.TabletType
	294, // 121: vtctldata.MoveTablesCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	11,  // 122: vtctldata.MoveTablesCreateRequest.workflow_options:type_name -> vtctldata.WorkflowOptions
	276, // 123: vtctldata.MoveTablesCreateResponse.details:type_name -> vtctldata.MoveTablesCreateResponse.TabletInfo
	297, // 124: vtctldata.PingTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 125: vtctldata.PlannedReparentShardRequest.new_primary:type_name -> topodata.TabletAlias
	297, // 126: vtctldata.PlannedReparentShardRequest.avoid_primary:type_name -> topodata.TabletAlias
	298, // 127: vtctldata.PlannedReparentShardRequest.wait_replicas_timeout:type_name -> vttime.Duration
	298, // 128: vtctldata.PlannedReparentShardRequest.tolerable_replication_lag:type_name -> vttime.Duration
	297, // 129: vtctldata.PlannedReparentShardResponse.promoted_primary:type_name -> topodata.TabletAlias
	293, // 130: vtctldata.PlannedReparentShardResponse.events:type_name -> logutil.Event
	297, // 131: vtctldata.RefreshStateRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 132: vtctldata.ReloadSchemaRequest.tablet_alias:type_name -> topodata.TabletAlias
	293, // 133: vtctldata.ReloadSchemaKeyspaceResponse.events:type_name -> logutil.Event
	293, // 134: vtctldata.ReloadSchemaShardResponse.events:type_name -> logutil.Event
	297, // 135: vtctldata.ReparentTabletRequest.tablet:type_name -> topodata.TabletAlias
	297, // 136: vtctldata.ReparentTabletResponse.primary:type_name -> topodata.TabletAlias
	306, // 137: vtctldata.ReshardCreateRequest.tablet_types:type_name -> topodata.TabletType
	294, // 138: vtctldata.ReshardCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	297, // 139: vtctldata.RestoreFromBackupRequest.tablet_alias:type_name -> topodata.TabletAlias
	296, // 140: vtctldata.RestoreFromBackupRequest.backup_time:type_name -> vttime.Time
	296, // 141: vtctldata.RestoreFromBackupRequest.restore_to_timestamp:type_name -> vttime.Time
	297, // 142: vtctldata.RestoreFromBackupResponse.tablet_alias:type_name -> topodata.TabletAlias
	293, // 143: vtctldata.RestoreFromBackupResponse.event:type_name -> logutil.Event
	277, // 144: vtctldata.RetrySchemaMigrationResponse.rows_affected_by_shard:type_name -> vtctldata.RetrySchemaMigrationResponse.RowsAffectedByShardEntry
	297, // 145: vtctldata.RunHealthCheckRequest.tablet_alias:type_name -> topodata.TabletAlias
	295, // 146: vtctldata.SetKeyspaceDurabilityPolicyResponse.keyspace:type_name -> topodata.Keyspace
	295, // 147: vtctldata.SetKeyspaceShardingInfoResponse.keyspace:type_name -> topodata.Keyspace
	299, // 148: vtctldata.SetShardIsPrimaryServingResponse.shard:type_name -> topodata.Shard
	306, // 149: vtctldata.SetShardTabletControlRequest.tablet_type:type_name -> topodata.TabletType
	299, // 150: vtctldata.SetShardTabletControlResponse.shard:type_name -> topodata.Shard
	297, // 151: vtctldata.SetWritableRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 152: vtctldata.ShardReplicationAddRequest.tablet_alias:type_name -> topodata.TabletAlias
	320, // 153: vtctldata.ShardReplicationFixResponse.error:type_name -> topodata.ShardReplicationError
	278, // 154: vtctldata.ShardReplicationPositionsResponse.replication_statuses:type_name -> vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry
	279, // 155: vtctldata.ShardReplicationPositionsResponse.tablet_map:type_name -> vtctldata.ShardReplicationPositionsResponse.TabletMapEntry
	297, // 156: vtctldata.ShardReplicationRemoveRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 157: vtctldata.SleepTabletRequest.tablet_alias:type_name -> topodata.TabletAlias
	298, // 158: vtctldata.SleepTabletRequest.duration:type_name -> vttime.Duration
	321, // 159: vtctldata.SourceShardAddRequest.key_range:type_name -> topodata.KeyRange
	299, // 160: vtctldata.SourceShardAddResponse.shard:type_name -> topodata.Shard
	299, // 161: vtctldata.SourceShardDeleteResponse.shard:type_name -> topodata.Shard
	297, // 162: vtctldata.StartReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 163: vtctldata.StopReplicationRequest.tablet_alias:type_name -> topodata.TabletAlias
	297, // 164: vtctldata.TabletExternallyReparentedRequest.tablet:type_name -> topodata.TabletAlias
	297, // 165: vtctldata.TabletExternallyReparentedResponse.new_primary:type_name -> topodata.TabletAlias
	297, // 166: vtctldata.TabletExternallyReparentedResponse.old_primary:type_name -> topodata.TabletAlias
	300, // 167: vtctldata.UpdateCellInfoRequest.cell_info:type_name -> topodata.CellInfo
	300, // 168: vtctldata.UpdateCellInfoResponse.cell_info:type_name -> topodata.CellInfo
	322, // 169: vtctldata.UpdateCellsAliasRequest.cells_alias:type_name -> topodata.CellsAlias
	322, // 170: vtctldata.UpdateCellsAliasResponse.cells_alias:type_name -> topodata.CellsAlias
	280, // 171: vtctldata.ValidateResponse.results_by_keyspace:type_name -> vtctldata.ValidateResponse.ResultsByKeyspaceEntry
	281, // 172: vtctldata.ValidateKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateKeyspaceResponse.ResultsByShardEntry
	282, // 173: vtctldata.ValidateSchemaKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateSchemaKeyspaceResponse.ResultsByShardEntry
	283, // 174: vtctldata.ValidateVersionKeyspaceResponse.results_by_shard:type_name -> vtctldata.ValidateVersionKeyspaceResponse.ResultsByShardEntry
	284, // 175: vtctldata.ValidateVSchemaResponse.results_by_shard:type_name -> vtctldata.ValidateVSchemaResponse.ResultsByShardEntry
	306, // 176: vtctldata.VDiffCreateRequest.tablet_types:type_name -> topodata.TabletType
	294, // 177: vtctldata.VDiffCreateRequest.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	298, // 178: vtctldata.VDiffCreateRequest.filtered_replication_wait_time:type_name -> vttime.Duration
	298, // 179: vtctldata.VDiffCreateRequest.wait_update_interval:type_name -> vttime.Duration
	298, // 180: vtctldata.VDiffCreateRequest.max_diff_duration:type_name -> vttime.Duration
	285, // 181: vtctldata.VDiffShowResponse.tablet_responses:type_name -> vtctldata.VDiffShowResponse.TabletResponsesEntry
	286, // 182: vtctldata.WorkflowDeleteResponse.details:type_name -> vtctldata.WorkflowDeleteResponse.TabletInfo
	290, // 183: vtctldata.WorkflowStatusResponse.table_copy_state:type_name -> vtctldata.WorkflowStatusResponse.TableCopyStateEntry
	291, // 184: vtctldata.WorkflowStatusResponse.shard_streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamsEntry
	306, // 185: vtctldata.WorkflowSwitchTrafficRequest.tablet_types:type_name -> topodata.TabletType
	298, // 186: vtctldata.WorkflowSwitchTrafficRequest.max_replication_lag_allowed:type_name -> vttime.Duration
	298, // 187: vtctldata.WorkflowSwitchTrafficRequest.timeout:type_name -> vttime.Duration
	323, // 188: vtctldata.WorkflowUpdateRequest.tablet_request:type_name -> tabletmanagerdata.UpdateVReplicationWorkflowRequest
	292, // 189: vtctldata.WorkflowUpdateResponse.details:type_name -> vtctldata.WorkflowUpdateResponse.TabletInfo
	324, // 190: vtctldata.GetMirrorRulesResponse.mirror_rules:type_name -> vschema.MirrorRules
	306, // 191: vtctldata.WorkflowMirrorTrafficRequest.tablet_types:type_name -> topodata.TabletType
	256, // 192: vtctldata.Workflow.ShardStreamsEntry.value:type_name -> vtctldata.Workflow.ShardStream
	257, // 193: vtctldata.Workflow.ShardStream.streams:type_name -> vtctldata.Workflow.Stream
	325, // 194: vtctldata.Workflow.ShardStream.tablet_controls:type_name -> topodata.Shard.TabletControl
	297, // 195: vtctldata.Workflow.Stream.tablet:type_name -> topodata.TabletAlias
	326, // 196: vtctldata.Workflow.Stream.binlog_source:type_name -> binlogdata.BinlogSource
	296, // 197: vtctldata.Workflow.Stream.transaction_timestamp:type_name -> vttime.Time
	296, // 198: vtctldata.Workflow.Stream.time_updated:type_name -> vttime.Time
	258, // 199: vtctldata.Workflow.Stream.copy_states:type_name -> vtctldata.Workflow.Stream.CopyState
	259, // 200: vtctldata.Workflow.Stream.logs:type_name -> vtctldata.Workflow.Stream.Log
	260, // 201: vtctldata.Workflow.Stream.throttler_status:type_name -> vtctldata.Workflow.Stream.ThrottlerStatus
	306, // 202: vtctldata.Workflow.Stream.tablet_types:type_name -> topodata.TabletType
	294, // 203: vtctldata.Workflow.Stream.tablet_selection_preference:type_name -> tabletmanagerdata.TabletSelectionPreference
	296, // 204: vtctldata.Workflow.Stream.Log.created_at:type_name -> vttime.Time
	296, // 205: vtctldata.Workflow.Stream.Log.updated_at:type_name -> vttime.Time
	296, // 206: vtctldata.Workflow.Stream.ThrottlerStatus.time_throttled:type_name -> vttime.Time
	263, // 207: vtctldata.ApplyVSchemaResponse.UnknownVindexParamsEntry.value:type_name -> vtctldata.ApplyVSchemaResponse.ParamList
	10,  // 208: vtctldata.FindAllShardsInKeyspaceResponse.ShardsEntry.value:type_name -> vtctldata.Shard
	322, // 209: vtctldata.GetCellsAliasesResponse.AliasesEntry.value:type_name -> topodata.CellsAlias
	327, // 210: vtctldata.GetShardReplicationResponse.ShardReplicationByCellEntry.value:type_name -> topodata.ShardReplication
	272, // 211: vtctldata.GetSrvKeyspaceNamesResponse.NamesEntry.value:type_name -> vtctldata.GetSrvKeyspaceNamesResponse.NameList
	328, // 212: vtctldata.GetSrvKeyspacesResponse.SrvKeyspacesEntry.value:type_name -> topodata.SrvKeyspace
	318, // 213: vtctldata.GetSrvVSchemasResponse.SrvVSchemasEntry.value:type_name -> vschema.SrvVSchema
	297, // 214: vtctldata.MoveTablesCreateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	329, // 215: vtctldata.ShardReplicationPositionsResponse.ReplicationStatusesEntry.value:type_name -> replicationdata.Status
	307, // 216: vtctldata.ShardReplicationPositionsResponse.TabletMapEntry.value:type_name -> topodata.Tablet
	...
	330, // 222: vtctldata.VDiffShowResponse.TabletResponsesEntry.value:type_name -> tabletmanagerdata.VDiffResponse
	297, // 223: vtctldata.WorkflowDeleteResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
	297, // 224: vtctldata.WorkflowStatusResponse.ShardStreamState.tablet:type_name -> topodata.TabletAlias
	288, // 225: vtctldata.WorkflowStatusResponse.ShardStreams.streams:type_name -> vtctldata.WorkflowStatusResponse.ShardStreamState
	287, // 226: vtctldata.WorkflowStatusResponse.TableCopyStateEntry.value:type_name -> vtctldata.WorkflowStatusResponse.TableCopyState
	289, // 227: vtctldata.WorkflowStatusResponse.ShardStreamsEntry.value:type_name -> vtctldata.WorkflowStatusResponse.ShardStreams
	297, // 228: vtctldata.WorkflowUpdateResponse.TabletInfo.tablet:type_name -> topodata.TabletAlias
