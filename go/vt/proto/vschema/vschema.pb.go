...
const (
	TenantStatus_UNKNOWN    TenantStatus = 0
	TenantStatus_INPROGRESS TenantStatus = 1
	TenantStatus_MIGRATED   TenantStatus = 2
)
...
type SrvVSchema struct {
	...
	TenantMigrations  *TenantMigrations    `protobuf:"bytes,4,opt,name=tenant_migrations,json=tenantMigrations,proto3" json:"tenant_migrations,omitempty"`
}
...
func (x *SrvVSchema) GetTenantMigrations() *TenantMigrations {
	if x != nil {
		return x.TenantMigrations
	}
	return nil
}
...
type TenantMigrations struct {
	...
	Statuses []*TenantMigration `protobuf:"bytes,1,rep,name=statuses,proto3" json:"statuses,omitempty"`
}

func (x *TenantMigrations) Reset() {
	*x = TenantMigrations{}
	if protoimpl.UnsafeEnabled {
...
func (x *TenantMigrations) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TenantMigrations) ProtoMessage() {}

func (x *TenantMigrations) ProtoReflect() protoreflect.Message {
	mi := &file_vschema_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TenantMigrations.ProtoReflect.Descriptor instead.
func (*TenantMigrations) Descriptor() ([]byte, []int) {
	return file_vschema_proto_rawDescGZIP(), []int{11}
}

func (x *TenantMigrations) GetStatuses() []*TenantMigration {
	if x != nil {
		return x.Statuses
	}
	return nil
...
type TenantMigration struct {
	...
	Status   TenantStatus `protobuf:"varint,2,opt,name=status,proto3,enum=vschema.TenantStatus" json:"status,omitempty"`
}

func (x *TenantMigration) Reset() {
	*x = TenantMigration{}
	if protoimpl.UnsafeEnabled {
...
func (x *TenantMigration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TenantMigration) ProtoMessage() {}

func (x *TenantMigration) ProtoReflect() protoreflect.Message {
	mi := &file_vschema_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TenantMigration.ProtoReflect.Descriptor instead.
func (*TenantMigration) Descriptor() ([]byte, []int) {
	return file_vschema_proto_rawDescGZIP(), []int{12}
}

func (x *TenantMigration) GetTenantId() int64 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
func (x *TenantMigration) GetStatus() TenantStatus {
	if x != nil {
		return x.Status
	}
	return TenantStatus_UNKNOWN
}
...
var file_vschema_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x22, 0xef, 0x02, 0x0a, 0x0a, 0x53, 0x72, 0x76, 0x56, 0x53,
	...
	0x46, 0x0a, 0x11, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f, 0x6d, 0x69, 0x67, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x76, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x4d, 0x69, 0x67, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x10, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x4d, 0x69, 0x67,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x4f, 0x0a, 0x0e, 0x4b, 0x65, 0x79, 0x73, 0x70,
	...
	,
...
var file_vschema_proto_goTypes = []interface{}{
	(TenantStatus)(0),            // 0: vschema.TenantStatus
	...
	(*TenantMigrations)(nil),     // 13: vschema.TenantMigrations
	(*TenantMigration)(nil),      // 14: vschema.TenantMigration
...
var file_vschema_proto_depIdxs = []int32{
	...
	1,  // 3: vschema.Keyspace.foreign_key_mode:type_name -> vschema.Keyspace.ForeignKeyMode
	17, // 4: vschema.Vindex.params:type_name -> vschema.Vindex.ParamsEntry
	7,  // 5: vschema.Table.column_vindexes:type_name -> vschema.ColumnVindex
	8,  // 6: vschema.Table.auto_increment:type_name -> vschema.AutoIncrement
	9,  // 7: vschema.Table.columns:type_name -> vschema.Column
	...
	2,  // 10: vschema.SrvVSchema.routing_rules:type_name -> vschema.RoutingRules
	11, // 11: vschema.SrvVSchema.shard_routing_rules:type_name -> vschema.ShardRoutingRules
	13, // 12: vschema.SrvVSchema.tenant_migrations:type_name -> vschema.TenantMigrations
	12, // 13: vschema.ShardRoutingRules.rules:type_name -> vschema.ShardRoutingRule
	14, // 14: vschema.TenantMigrations.statuses:type_name -> vschema.TenantMigration
	0,  // 15: vschema.TenantMigration.status:type_name -> vschema.TenantStatus
	...
	4,  // 18: vschema.SrvVSchema.KeyspacesEntry.value:type_name -> vschema.Keyspace
