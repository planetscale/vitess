...
type RemoveQueryRequest struct {
	...
	//	*RemoveQueryRequest_Name
	//	*RemoveQueryRequest_PublicId
	Remove isRemoveQueryRequest_Remove `protobuf_oneof:"remove"`
}
...
func (m *RemoveQueryRequest) GetRemove() isRemoveQueryRequest_Remove {
	if m != nil {
		return m.Remove
	}
	return nil
...
func (x *RemoveQueryRequest) GetName() string {
	if x, ok := x.GetRemove().(*RemoveQueryRequest_Name); ok {
		return x.Name
	}
	return ""
}

func (x *RemoveQueryRequest) GetPublicId() string {
	if x, ok := x.GetRemove().(*RemoveQueryRequest_PublicId); ok {
		return x.PublicId
	}
	return ""
}

type isRemoveQueryRequest_Remove interface {
	isRemoveQueryRequest_Remove()
}

type RemoveQueryRequest_Name struct {
	Name string `protobuf:"bytes,1,opt,name=name,proto3,oneof"`
}

type RemoveQueryRequest_PublicId struct {
	PublicId string `protobuf:"bytes,2,opt,name=public_id,json=publicId,proto3,oneof"`
}

func (*RemoveQueryRequest_Name) isRemoveQueryRequest_Remove() {}

func (*RemoveQueryRequest_PublicId) isRemoveQueryRequest_Remove() {}
...
var file_vtboost_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x71, 0x75, 0x65, 0x72, 0x69, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x12, 0x52, 0x65, 0x6d,
	...
	0x03, 0x52, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x42, 0x26, 0x5a, 0x24, 0x76, 0x69,
	0x74, 0x65, 0x73, 0x73, 0x2e, 0x69, 0x6f, 0x2f, 0x76, 0x69, 0x74, 0x65, 0x73, 0x73, 0x2f, 0x67,
	0x6f, 0x2f, 0x76, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x76, 0x74, 0x62, 0x6f, 0x6f,
...
var file_vtboost_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_vtboost_proto_depIdxs = []int32{
	...
	0, // 1: vtboost.ListQueriesResponse.queries:type_name -> vtboost.CachedQuery
...
func file_vtboost_proto_init() {
	...
	file_vtboost_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*RemoveQueryRequest_Name)(nil),
		(*RemoveQueryRequest_PublicId)(nil),
	}
	type x struct{}
