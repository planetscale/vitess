...
type StreamHealthRequestType int32

const (
	StreamHealthRequestType_DEFAULT          StreamHealthRequestType = 0
	StreamHealthRequestType_TABLET_THROTTLER StreamHealthRequestType = 1
)

// Enum value maps for StreamHealthRequestType.
var (
	StreamHealthRequestType_name = map[int32]string{
		0: "DEFAULT",
		1: "TABLET_THROTTLER",
	}
	StreamHealthRequestType_value = map[string]int32{
		"DEFAULT":          0,
		"TABLET_THROTTLER": 1,
	}
)

func (x StreamHealthRequestType) Enum() *StreamHealthRequestType {
	p := new(StreamHealthRequestType)
	*p = x
	return p
}

func (x StreamHealthRequestType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StreamHealthRequestType) Descriptor() protoreflect.EnumDescriptor {
	return file_query_proto_enumTypes[3].Descriptor()
}

func (StreamHealthRequestType) Type() protoreflect.EnumType {
	return &file_query_proto_enumTypes[3]
}

func (x StreamHealthRequestType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StreamHealthRequestType.Descriptor instead.
func (StreamHealthRequestType) EnumDescriptor() ([]byte, []int) {
...
type StreamHealthRequest struct {
	...
	Type StreamHealthRequestType `protobuf:"varint,1,opt,name=type,proto3,enum=query.StreamHealthRequestType" json:"type,omitempty"`
}
...
func (x *StreamHealthRequest) GetType() StreamHealthRequestType {
	if x != nil {
		return x.Type
	}
	return StreamHealthRequestType_DEFAULT
}
...
type RealtimeStats struct {
	...
	ThrottlerStats    *RealtimeStats_ThrottlerStats `protobuf:"bytes,9,opt,name=throttler_stats,json=throttlerStats,proto3" json:"throttler_stats,omitempty"`
}
...
func (x *RealtimeStats) GetThrottlerStats() *RealtimeStats_ThrottlerStats {
	if x != nil {
		return x.ThrottlerStats
	}
	return nil
}
...
type RealtimeStats_ThrottlerStats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ThrottlerMetricError string `protobuf:"bytes,1,opt,name=throttler_metric_error,json=throttlerMetricError,proto3" json:"throttler_metric_error,omitempty"`
	...
	ThrottlerReplicationLagSeconds float64 `protobuf:"fixed64,2,opt,name=throttler_replication_lag_seconds,json=throttlerReplicationLagSeconds,proto3" json:"throttler_replication_lag_seconds,omitempty"`
	...
	ThrottlerMetric float64 `protobuf:"fixed64,3,opt,name=throttler_metric,json=throttlerMetric,proto3" json:"throttler_metric,omitempty"`
	...
	ThrottlerMetricCollected bool `protobuf:"varint,4,opt,name=throttler_metric_collected,json=throttlerMetricCollected,proto3" json:"throttler_metric_collected,omitempty"`
}

func (x *RealtimeStats_ThrottlerStats) Reset() {
	*x = RealtimeStats_ThrottlerStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *RealtimeStats_ThrottlerStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RealtimeStats_ThrottlerStats) ProtoMessage() {}

func (x *RealtimeStats_ThrottlerStats) ProtoReflect() protoreflect.Message {
	mi := &file_query_proto_msgTypes[66]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RealtimeStats_ThrottlerStats.ProtoReflect.Descriptor instead.
func (*RealtimeStats_ThrottlerStats) Descriptor() ([]byte, []int) {
	return file_query_proto_rawDescGZIP(), []int{58, 0}
}

func (x *RealtimeStats_ThrottlerStats) GetThrottlerMetricError() string {
	if x != nil {
...
func (x *RealtimeStats_ThrottlerStats) GetThrottlerReplicationLagSeconds() float64 {
	if x != nil {
...
func (x *RealtimeStats_ThrottlerStats) GetThrottlerMetric() float64 {
	if x != nil {
...
func (x *RealtimeStats_ThrottlerStats) GetThrottlerMetricCollected() bool {
	if x != nil {
...
var file_query_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x49, 0x0a, 0x13, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x32,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x48, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x22, 0xc1, 0x05, 0x0a, 0x0d, 0x52, 0x65, 0x61, 0x6c, 0x74, 0x69, 0x6d, 0x65, 0x53,
	...
	,
	...
	0x42, 0x49, 0x54, 0x4e, 0x55, 0x4d, 0x10, 0xa2, 0x20, 0x2a, 0x3c, 0x0a, 0x17, 0x53, 0x74, 0x72,
	...
	0x00, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x41, 0x42, 0x4c, 0x45, 0x54, 0x5f, 0x54, 0x48, 0x52, 0x4f,
	0x54, 0x54, 0x4c, 0x45, 0x52, 0x10, 0x01, 0x2a, 0x46, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73,
...
var file_query_proto_goTypes = []interface{}{
	...
	(Flag)(0),                                 // 1: query.Flag
	(Type)(0),                                 // 2: query.Type
	(StreamHealthRequestType)(0),              // 3: query.StreamHealthRequestType
	...
	(*RealtimeStats_ThrottlerStats)(nil),      // 79: query.RealtimeStats.ThrottlerStats
...
var file_query_proto_depIdxs = []int32{
	...
	14,  // 58: query.SetRollbackRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 59: query.SetRollbackRequest.target:type_name -> query.Target
	82,  // 60: query.ConcludeTransactionRequest.effective_caller_id:type_name -> vtrpc.CallerID
	14,  // 61: query.ConcludeTransactionRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 62: query.ConcludeTransactionRequest.target:type_name -> query.Target
	82,  // 63: query.ReadTransactionRequest.effective_caller_id:type_name -> vtrpc.CallerID
	14,  // 64: query.ReadTransactionRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 65: query.ReadTransactionRequest.target:type_name -> query.Target
	74,  // 66: query.ReadTransactionResponse.metadata:type_name -> query.TransactionMetadata
	82,  // 67: query.BeginExecuteRequest.effective_caller_id:type_name -> vtrpc.CallerID
	14,  // 68: query.BeginExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 69: query.BeginExecuteRequest.target:type_name -> query.Target
	18,  // 70: query.BeginExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 71: query.BeginExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 72: query.BeginExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 73: query.BeginExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 76: query.BeginStreamExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 77: query.BeginStreamExecuteRequest.target:type_name -> query.Target
	18,  // 78: query.BeginStreamExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 79: query.BeginStreamExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 80: query.BeginStreamExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 81: query.BeginStreamExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 84: query.MessageStreamRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 85: query.MessageStreamRequest.target:type_name -> query.Target
	22,  // 86: query.MessageStreamResponse.result:type_name -> query.QueryResult
	82,  // 87: query.MessageAckRequest.effective_caller_id:type_name -> vtrpc.CallerID
	14,  // 88: query.MessageAckRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 89: query.MessageAckRequest.target:type_name -> query.Target
	16,  // 90: query.MessageAckRequest.ids:type_name -> query.Value
	22,  // 91: query.MessageAckResponse.result:type_name -> query.QueryResult
	82,  // 92: query.ReserveExecuteRequest.effective_caller_id:type_name -> vtrpc.CallerID
	14,  // 93: query.ReserveExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 94: query.ReserveExecuteRequest.target:type_name -> query.Target
	18,  // 95: query.ReserveExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 96: query.ReserveExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 97: query.ReserveExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 98: query.ReserveExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 101: query.ReserveStreamExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 102: query.ReserveStreamExecuteRequest.target:type_name -> query.Target
	18,  // 103: query.ReserveStreamExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 104: query.ReserveStreamExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 105: query.ReserveStreamExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 106: query.ReserveStreamExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 109: query.ReserveBeginExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 110: query.ReserveBeginExecuteRequest.target:type_name -> query.Target
	18,  // 111: query.ReserveBeginExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 112: query.ReserveBeginExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 113: query.ReserveBeginExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 114: query.ReserveBeginExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 117: query.ReserveBeginStreamExecuteRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 118: query.ReserveBeginStreamExecuteRequest.target:type_name -> query.Target
	18,  // 119: query.ReserveBeginStreamExecuteRequest.query:type_name -> query.BoundQuery
	19,  // 120: query.ReserveBeginStreamExecuteRequest.options:type_name -> query.ExecuteOptions
	83,  // 121: query.ReserveBeginStreamExecuteResponse.error:type_name -> vtrpc.RPCError
	22,  // 122: query.ReserveBeginStreamExecuteResponse.result:type_name -> query.QueryResult
	...
	14,  // 125: query.ReleaseRequest.immediate_caller_id:type_name -> query.VTGateCallerID
	13,  // 126: query.ReleaseRequest.target:type_name -> query.Target
	3,   // 127: query.StreamHealthRequest.type:type_name -> query.StreamHealthRequestType
	79,  // 128: query.RealtimeStats.throttler_stats:type_name -> query.RealtimeStats.ThrottlerStats
	13,  // 129: query.StreamHealthResponse.target:type_name -> query.Target
	71,  // 130: query.StreamHealthResponse.realtime_stats:type_name -> query.RealtimeStats
	84,  // 131: query.StreamHealthResponse.tablet_alias:type_name -> topodata.TabletAlias
	4,   // 132: query.TransactionMetadata.state:type_name -> query.TransactionState
	...
	5,   // 135: query.GetSchemaRequest.table_type:type_name -> query.SchemaTableType
...
func file_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_query_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RealtimeStats_ThrottlerStats); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
