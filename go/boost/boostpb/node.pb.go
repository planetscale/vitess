...
func (Node_InternalJoin_JoinType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 6, 0}
}
...
func (Node_InternalGrouped_Aggregation_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 7, 0, 0}
}
...
func (*Node_Base) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 0}
}
...
func (*Node_Egress) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 3}
}
...
type Node_Reader struct {
	...
	ColLen     int             `protobuf:"varint,4,opt,name=col_len,json=colLen,proto3,casttype=int" json:"col_len,omitempty"`
}
...
func (*Node_Reader) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 4}
}
...
func (*Node_InternalUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5}
}
...
func (*Node_InternalUnion_EmitProject) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 0}
}
...
func (*Node_InternalUnion_EmitProject_EmitTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 0, 0}
}
...
func (*Node_InternalUnion_EmitProject_EmitLeftTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 0, 1}
}
...
func (*Node_InternalUnion_EmitProject_ColumnsTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 0, 2}
}
...
func (*Node_InternalUnion_EmitProject_ColumnsLeftTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 0, 3}
}
...
func (*Node_InternalUnion_EmitAll) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 5, 1}
}
...
func (*Node_InternalJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 6}
}
...
func (*Node_InternalGrouped) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 7}
}
...
func (*Node_InternalGrouped_Aggregation) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 7, 0}
}
...
func (*Node_InternalProject) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 8}
}
...
func (*Node_InternalFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 9}
}
...
func (*Node_InternalFilter_FilterExpr) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 9, 0}
}
...
type Node_InternalTopK struct {
	Src          *IndexPair `protobuf:"bytes,1,opt,name=src,proto3" json:"src,omitempty"`
	OrderOffsets []int      `protobuf:"varint,2,rep,packed,name=order_offsets,json=orderOffsets,proto3,casttype=int" json:"order_offsets,omitempty"`
	OrderAsc     []bool     `protobuf:"varint,3,rep,packed,name=order_asc,json=orderAsc,proto3" json:"order_asc,omitempty"`
	K            uint       `protobuf:"varint,4,opt,name=K,proto3,casttype=uint" json:"K,omitempty"`
...
func (*Node_InternalTopK) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 10}
}
...
func (*Node_InternalDistinct) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 11}
}
...
func (*Node_Sharder) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c843d59d2d938e7, []int{5, 12}
}
...
var fileDescriptor_0c843d59d2d938e7 = []byte{
	...
	,
}
...
func (m *Node_Reader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ColLen != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.ColLen))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Node_InternalTopK) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderAsc) > 0 {
		for iNdEx := len(m.OrderAsc) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.OrderAsc[iNdEx] {
				dAtA[i] = 1
			} else {
		...
		i = encodeVarintNode(dAtA, i, uint64(len(m.OrderAsc)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.OrderOffsets) > 0 {
		dAtA52 := make([]byte, len(m.OrderOffsets)*10)
		var j51 int
		for _, num1 := range m.OrderOffsets {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintNode(dAtA, i, uint64(j51))
		i--
		dAtA[i] = 0x12
	}
	if m.Src != nil {
...
func (m *Node_InternalDistinct) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Params) > 0 {
		dAtA55 := make([]byte, len(m.Params)*10)
		var j54 int
		for _, num1 := range m.Params {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintNode(dAtA, i, uint64(j54))
		i--
		dAtA[i] = 0x12
	}
	if m.Src != nil {
...
func (m *Node_InternalTopK) Size() (n int) {
	...
	if len(m.OrderOffsets) > 0 {
		l = 0
		for _, e := range m.OrderOffsets {
			l += sovNode(uint64(e))
		}
		n += 1 + sovNode(uint64(l)) + l
	}
	if len(m.OrderAsc) > 0 {
		n += 1 + sovNode(uint64(len(m.OrderAsc))) + len(m.OrderAsc)*1
	}
	if m.K != 0 {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				m.OrderOffsets = append(m.OrderOffsets, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.OrderOffsets) == 0 {
					m.OrderOffsets = make([]int, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field OrderOffsets", wireType)
			}
		case 3:
			if wireType == 0 {
				var v int
				...
				m.OrderAsc = append(m.OrderAsc, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.OrderAsc) == 0 {
					m.OrderAsc = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field OrderAsc", wireType)
			}
		case 4:
			if wireType != 0 {
