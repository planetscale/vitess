...
SELECT /*vt+ VIEW=private_photos PUBLIC */ photo.p_id FROM photo JOIN (
...
SELECT /*vt+ VIEW=public_photos PUBLIC */ photo.p_id FROM photo JOIN album ON (photo.album = album.a_id) WHERE album.public = 1 AND album.a_id = :album_id;