			...
			t.Run("cleanup", func(t *testing.T) {
				...
				for range artifacts {
					for _, artifact := range artifacts {
						...
						_, err := clusterInstance.VtctlclientProcess.ApplySchemaWithOutput(keyspaceName, statement, cluster.VtctlClientParams{DDLStrategy: "direct --unsafe-allow-foreign-keys"})
						if err == nil {
