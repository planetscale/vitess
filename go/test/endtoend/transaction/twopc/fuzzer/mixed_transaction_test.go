...
func newMixedTxFuzzer(singleShardThreads, crossShardThreads, updateSets int, clusterDisruptions []func(), disruptionProbability []int) *mixedTxFuzzer {
	fz := &mixedTxFuzzer{
...
func (fz *mixedTxFuzzer) runClusterDisruptionThread() {
	// Whenever we finish running this thread, we should mark the thread has stopped.
	defer func() {
		fz.wg.Done()
	}()
...
func (fz *mixedTxFuzzer) runClusterDisruption() {
