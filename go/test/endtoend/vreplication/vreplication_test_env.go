...
var dryRunResultsSwitchWritesCustomerShard = []string{
	...
	"Stop writes on keyspace product, tables [Lead,Lead-1,blob_tbl,customer,db_order_test]:",
	...
	"Enable writes on keyspace customer tables [Lead,Lead-1,blob_tbl,customer,db_order_test]",
	"Switch routing from keyspace product to keyspace customer",
	"Routing rules for tables [Lead,Lead-1,blob_tbl,customer,db_order_test] will be updated",
...
var dryRunResultsReadCustomerShard = []string{
	"Lock keyspace product",
	"Switch reads for tables [Lead,Lead-1,blob_tbl,customer,db_order_test] to keyspace customer for tablet types [REPLICA,RDONLY]",
	"Routing rules for tables [Lead,Lead-1,blob_tbl,customer,db_order_test] will be updated",
	"Unlock keyspace product",
}
...
var dryRunResultsDropSourcesDropCustomerShard = []string{
	...
	"	Keyspace product Shard 0 DbName vt_product Tablet 100 Table blob_tbl",
	...
	"Denied tables [Lead,Lead-1,blob_tbl,customer,db_order_test] will be removed from:",
